...
dirs = ["ai_config/ai_server/skill_type", "ai_config/5v5/tactics/feature",
        "ai_config/5v5/common", "ai_config/ai_server/pb2struct"]
for d in dirs:
...
for p, c in files.items():
    with open(os.path.join(ailab, p), "w") as f:
        f.write(c)
print("AILab stubs created OK", flush=True)
