...
# Create AILab in hok1v1 directory
...
gl = GamecoreClient(server_addr="host.docker.internal:23432", gamecore_req_timeout=60000, default_hero_config=get_default_hero_config())
addrs = [f"tcp://0.0.0.0:{ZMQ_PORT_BASE + i}" for i in range(2)]
env = HoK1v1("test", gl, lib, addrs, aiserver_ip="172.24.50.71")
